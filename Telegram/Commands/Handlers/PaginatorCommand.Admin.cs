...
replyMarkup: new InlineKeyboardMarkup(
    ...
    {
        new InlineKeyboardButton[] { InlineKeyboardButton.WithCallbackData("Persisted across pages") },
        new InlineKeyboardButton[] { InlineKeyboardButton.WithCallbackData("This one too")
        }
    })
);
        }
