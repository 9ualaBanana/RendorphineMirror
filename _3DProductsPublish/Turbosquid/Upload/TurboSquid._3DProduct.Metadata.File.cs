    ...
    public partial record _3DProduct
    {
        public partial record Metadata__
        {
            internal class File
            {
                ...
                string? _path;
                internal readonly _3DProduct<Metadata__> _3DProduct;

                internal static File For(_3DProduct<Metadata__> _3DProduct) => new(_3DProduct);
                File(_3DProduct<Metadata__> _3DProduct)
