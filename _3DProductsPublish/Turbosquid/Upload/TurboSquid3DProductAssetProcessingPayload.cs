...
abstract class TurboSquid3DProductAssetProcessingPayload
{
    ...
    internal static TurboSquid3DProductAssetProcessingPayload For(FileStream archived3DModel, string uploadKey, TurboSquid3DProductUploadSessionContext uploadSessionContext, string formatVersion, string renderer, string? rendererVersion, bool isNative)
    ...
    internal static TurboSquid3DProductAssetProcessingPayload For(FileStream archived3DModel, string uploadKey, string draftId, string authenticityToken, string formatVersion, string renderer, string? rendererVersion, bool isNative)
    ...
    internal static TurboSquid3DProductAssetProcessingPayload For(TurboSquid3DProductThumbnail thumbnail, string uploadKey, TurboSquid3DProductUploadSessionContext uploadSessionContext)
        => For(thumbnail, uploadKey, uploadSessionContext.ProductDraft._ID, uploadSessionContext.Credential._CsrfToken);
    internal static TurboSquid3DProductAssetProcessingPayload For(TurboSquid3DProductThumbnail thumbnail, string uploadKey, string draftId, string authenticityToken)
    ...
    internal TurboSquid3DProductAssetProcessingPayload(
        string uploadKey,
        string resource,
        string draftId,
        string name,
    ...
    internal class TurboSquid3DModelProcessingPayload : TurboSquid3DProductAssetProcessingPayload
    {
    ...
    internal class TurboSquidThumbnailProcessingPayload : TurboSquid3DProductAssetProcessingPayload
    {
