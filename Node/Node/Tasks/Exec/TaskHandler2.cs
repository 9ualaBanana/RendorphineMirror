...
public class TaskHandler2
{
    ...
    public TaskHandler2(IPlacedTasksStorage placedTasks, IQueuedTasksStorage queuedTasks, ICompletedTasksStorage completedTasks, IWatchingTasksStorage watchingTasks,
        PluginManager pluginManager, NodeCommon.Apis api, NodeGlobalState nodeGlobalState, ILogger<TaskHandler2> logger)
    {
