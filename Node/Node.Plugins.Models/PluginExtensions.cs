...
public static class PluginExtensions
{
    ...
    public static Plugin GetPlugin(this IEnumerable<Plugin> plugins, PluginType type, string version) => plugins.GetPlugin(type, p => p.Version == version);
    public static Plugin? TryGetPlugin(this IEnumerable<Plugin> plugins, PluginType type, string version) => plugins.TryGetPlugin(type, p => p.Version == version);
