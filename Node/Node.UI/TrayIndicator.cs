...
{
    readonly byte[] IconBytes, GreenIconBytes;
    readonly WindowIcon None, Red, Yellow, Green;
    ...
    public required ILogger<TrayIndicator> Logger { get; init; }
    ...
    public TrayIndicator()
    {
        ...
        void InitializeColoredIcons(out byte[] greenbytes, out WindowIcon none, out WindowIcon red, out WindowIcon yellow, out WindowIcon green)
        {
    ...
    public static void PreventClosing(Window window)
    {
        window.Closing += (_, e) =>
        {
            e.Cancel = true;
    ...
    public void Initialize()
    {
        ...
        void open()
        {
            ...
            {
                var window = Lifetime.MainWindow ?? MainWindowUpdater.SetMainWindow();
    ...
    void InitializeIconInfo(TrayIcon icon)
    {
