...
public class UserSettingsManager
{
    ...
    string BuildUrl(string sessionId) => $"{_endpoint}?sessionid={sessionId}";
    ...
    public async Task<UserSettings?> TryFetchAsync(string sessionId)
    {
        try
        {
    ...
    public async Task<UserSettings> FetchAsync(string sessionId, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<bool> TrySetAsync(UserSettings userSettings, string sessionId, CancellationToken cancellationToken = default)
    {
    ...
    /// </remarks>
    public async Task SetAsync(UserSettings userSettings, string sessionId, CancellationToken cancellationToken = default)
    {
